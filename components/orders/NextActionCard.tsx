...
type NextActionCardProps = {
  ...
  reservationActionTitle?: string;
  reservationActionBody?: string;
...
function getPrimaryAction(params: {
  ...
  if (params.canReschedule) {
    return {
      title: params.reservationActionTitle ?? "방문 일정이 필요하신가요?",
      body: params.reservationActionBody ?? "방문 전이라면 가능한 일정으로 변경 요청할 수 있어요.",
      label: params.reservationActionLabel ?? "예약 변경",
      onClick: params.onReschedule
    };
  }
